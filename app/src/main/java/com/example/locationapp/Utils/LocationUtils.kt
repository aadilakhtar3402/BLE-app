...
object LocationUtils {
    ...
    private fun saveLocationDataToFile() {
        ...
        val locationFolder = File(downloadsFolder, "Location Data")
        ...
        locationFolder.listFiles()?.forEach { file ->
            if (file.isFile && file.name.startsWith("location_data_")) {
                val fileNumber = file.name.substringAfter("location_data_").substringBefore(".json").toIntOrNull()
        ...
        val fileName = "location_data_$nextFileNumber.json"
